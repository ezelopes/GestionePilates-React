...
const columnsDefinition = [
  ...
  { headerName: 'Data Iscrizione', field: 'RegistrationDate', cellRenderer: (params) => (params.value !== 'Invalid date') ? new Date(params.value).toLocaleDateString() : '' },
  { headerName: 'Data Scadenza Certificato', field: 'CertificateExpirationDate', cellRenderer: (params) => (params.value !== 'Invalid date') ? new Date(params.value).toLocaleDateString() : '' },
  { headerName: 'Data Nascita', field: 'DOB', cellRenderer: (params) => (params.value !== 'Invalid date') ? new Date(params.value).toLocaleDateString() : '' },
  { headerName: 'Data Green Pass', field: 'GreenPassExpirationDate', cellRenderer: (params) => (params.value !== 'Invalid date') ? new Date(params.value).toLocaleDateString() : '' },
