...
export const RegistrationFormDanceStezzanoTemplate = (studentInfo, labelLogo) => {
  const docDefinition = {
    info: {
      title: `${studentInfo.Name}_${studentInfo.Surname}_Modulo_Iscrizione_Dance_Stezzano`,
      author: 'Roxana Carro',
    ...
    content: [
      ...
      {
        text: 'PRESA VISIONE DELLO STATUTO E REGOLAMENTO CHE SI TROVA SUL SITO DELL’ASSOCIAZIONE WWW.PIL-ART.COM',
        style: 'subheader',
      },
      {
...

      {
        stack: [
          ...
          '[  ] DANZA CLASSICA - FISIOTECNICA (durata della lezione 1 ora)',
          '[  ] CLASSICO PRE-ACCADEMICO (durata della lezione 1 ora e mezza)',
          '[  ] DANZA MODERNA BABY (durata della lezione 1 ora)',
          '[  ] DANZA MODERNA KIDS 1 (durata della lezione 1 ora)',
          '[  ] DANZA MODERNA KIDS 2 (durata della lezione 1 ora)',
          '[  ] DANZA MODERNA CORSO INTERMEDIO (durata della lezione 1 ora e mezza)',
          '[  ] HIP HOP BABY (durata della lezione 1 ora)',
          '[  ] HIP HOP KIDS 1 (durata della lezione 1 ora)',
          '[  ] HIP HOP KIDS 2 (durata della lezione 1 ora)',
          '[  ] BREAKDANCE (durata della lezione 1 ora)',
          '[  ] VIDEODANCE TENNAGERS (durata della lezione 1 ora)',
          '[  ] MUSICAL TEENAGERS (durata della lezione 1 ora e mezza)',
          '[  ] MUSICAL KIDS (durata della lezione 1 ora)',
        ],
        style: 'normal',
      },
      {
        text: [
          ...
          {
            text: ' LA QUOTA D’ISCRIZIONE COMPRESA L’ASSICURAZIONE DI EURO 25.-  ',
            bold: true,
          },
        ],
        style: 'normal',
      ...
      { text: 'SCELGO DI PAGARE IL CORSO PRESCELTO (SI ALLEGA LISTINO DI PREZZI):', style: 'subheader' },
      {
        stack: [
          ...
          '[  ] IN 3 RATE RISPETTANDO LE DATE PRE-STABILITE PER IL VERSAMENTO DI CIASCUNA RATA (OTTOBRE, GENNAIO, MARZO) – IN CASO D’ISCRIZIONE A CORSO GIA’A VVIATO, VERSERO’ IL CORRISPONDENTE DETRAENDO LE LEZIONI NON FATTE - IN CASO DI ABBANDONO DEL CORSO NON CI SARA’ NESSUN RIMBORSO DELL’ULTIMA RATA VERSATA',
