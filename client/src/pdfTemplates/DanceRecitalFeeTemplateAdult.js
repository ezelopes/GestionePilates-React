...
const DanceRecitalFeeTemplateAdult = async (studentInfo, receiptInfo) => {
  ...
  const docDefinition = {
    ...
    content: [
      ...
      },
      {
        ...
        } EURO${centsInLetters.toUpperCase()}) per il contributo relativo alla quota del saggio di fine anno.`,
        alignment: 'center',
        lineHeight: 1.5,
        fontSize: 10,
        margin: [0, 0, 0, 10],
...
export default DanceRecitalFeeTemplateAdult;
