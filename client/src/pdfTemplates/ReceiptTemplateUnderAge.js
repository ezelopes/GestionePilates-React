...
export const ReceiptTemplateUnderAge = (studentInfo, receiptInfo, labelLogo, signature, stamp) => {
  ...
  const docDefinition = {
    ...
    content: [
      ...
      },
      {
        ...
        } residente in ${studentInfo.Address || BLANK_SPACE}, ${studentInfo.City || BLANK_SPACE} al corso di ${
